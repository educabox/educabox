...
🤖 Fabricante | RPC
🎛️ Modelo | MINI
⚙️ Placa Mãe | X96-MINI RH-4 94V-0
📝 Placa DTB | rk30sdk
...
O guia de instalação abaixo é para a criação de uma imagem limpa da [**[Imagem Oficial do Armbian]**](https://armbian.com/pt/boards/rk322x-box), com os parâmetros necessários para que o Armbian seja instalado corretamente na TV Box - [**RPC MINI**].
