...
Fabricante | MXQ
Modelo | PRO 4G 5K
Placa Mãe | MXQPRO_V72 2021-01-29
Placa DTB | rk30sdk
CPU | Rockchip 3228A
Família | Cortex-A7
...
✅ **Versões Recomendadas [MXQ PRO 4K 5G] = Kernel 4.4.194, 5.15.25, 6.1.63 ou 6.6.22** 
...
O guia de instalação abaixo é para criação de uma imagem limpa da [Imagem Oficial Armbian] com os parâmetros necessários para que o Armbian seja instalado corretamente na TV Box - [MXQ PRO 4K 5G].
...
2.  Edite o arquivo `armbianEnv.txt` em um editor de texto:
    ...
    4. MXQ PRO 4K 5G -> `fdtfile=rk322x-box.dtb` (*Remova #)
```
verbosity=1
