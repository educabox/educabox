...
|Imagens | Download|
---------|:--:
Oficial | [Armbian_23.11.1_Sunvell-r69_jammy_current_6.1.63_xfce_desktop.img.xz](https://imola.armbian.com/archive/sunvell-r69/archive/Armbian_23.11.1_Sunvell-r69_jammy_current_6.1.63_xfce_desktop.img.xz)
Educabox | [educabox_armbian_r69.img.gz](#)
DTB | --
...
2. Para finalizar a instalação altere a frequência para que os Processadores Allwinner não sofram com super aquecimento.
