...
**DTB** = [sun8i-h2-plus-sunvell-r69.dtb](https://drive.google.com/uc?export=download&id=1JCuA4rjqFGlpAAxSgWCSSkJzveyfsobB)
...
O guia de instalação abaixo é para a criação de uma imagem limpa da [**[Imagem Oficial do Armbian]**](https://archive.armbian.com/), com os parâmetros necessários para que o Armbian seja instalado corretamente na TV Box - [**R69**].
...
overlays=cir analog-codec usbhost0 usbhost1
fdtfile=sun8i-h2-plus-sunvell-r69.dtb
rootdev=UUID=[Não altere essa linha]
rootfstype=ext4
```
