...
🤖 Fabricante | RPC
🎛️ Modelo | PLUS
⚙️ Placa Mãe | R3229Q_V8.1 2020.06.15
📝 Placa DTB | rk30sdk
...
O guia de instalação abaixo é para a criação de uma imagem limpa da [**[Imagem Oficial do Armbian]**](https://armbian.com/pt/boards/rk322x-box), com os parâmetros necessários para que o Armbian seja instalado corretamente na TV Box - [**RPC PLUS**].
